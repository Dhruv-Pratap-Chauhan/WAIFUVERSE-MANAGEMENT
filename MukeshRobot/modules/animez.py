...
def upcoming(update: Update, context: CallbackContext):
    try:
        ...
        if "data" not in response:
            update.effective_message.reply_text("Could not retrieve upcoming anime at this time.")
            return

        upcoming_list = [entry["title"] for entry in response["data"]]
        upcoming_message = "<b>Upcoming Anime:</b>\n\n"

        for entry_num in range(min(len(upcoming_list), 10)):
            upcoming_message += f"{entry_num + 1}. {upcoming_list[entry_num]}\n"

        update.effective_message.reply_text(upcoming_message, parse_mode=ParseMode.HTML)
...
__help__ = """
 ...
 ❍ /upcoming*:* ʀᴇᴛᴜʀɴs ᴀ ʟɪsᴛ ᴏғ ᴜᴘᴄᴏᴍɪɴɢ ᴀɴɪᴍᴇ.
 ❍ /airing <ᴀɴɪᴍᴇ>*:* ʀᴇᴛᴜʀɴs ᴀɴɪᴍᴇ ᴀɪʀɪɴɢ ɪɴғᴏ.
 ❍ /quote*:* ɢᴇᴛ ᴛᴇxᴛ ᴀɴɪᴍᴇ ǫᴜᴏᴛᴇ.
 ❍ /animequotes*:* ɢᴇᴛ ɪᴍᴀɢᴇ ᴀɴɪᴍᴇ ǫᴜᴏᴛᴇ.
 ❍ /kaizoku <ᴀɴɪᴍᴇ>*:* sᴇᴀʀᴄʜ ᴀɴɪᴍᴇ ᴏɴ ᴀɴɪᴍᴇᴋᴀɪᴢᴏᴋᴜ.
 ❍ /kayo <ᴀɴɪᴍᴇ>*:* sᴇᴀʀᴄʜ ᴀɴɪᴍᴇ ᴏɴ ᴀɴɪᴍᴇᴋᴀʏᴏ.
"""

ANIME_HANDLER = DisableAbleCommandHandler(["anime", "anilist"], anime)
