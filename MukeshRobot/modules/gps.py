...
import asyncio
from MukeshRobot import pbot as dhruv
from pyrogram.handlers import MessageHandler
from geopy.geocoders import Nominatim
from geopy.distance import great_circle
@dhruv.on_message(filters.command(["gps"]))
...
#     await message.delete()
    ...
    try:
        ...
        """
        geolocator = Nominatim(user_agent="legend-Dhruv")
#         zoom=[0-18]
...
@dhruv.on_message(filters.command(["distance"]))
