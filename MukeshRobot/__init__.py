...
if ENV:
    ...
    SUPPORT_CHAT = os.environ.get("SUPPORT_CHAT", "-1002887384567")
...
telethn = TelegramClient("dhruv", API_ID, API_HASH)

pbot = Client("DhruvRobot", api_id=API_ID, api_hash=API_HASH, bot_token=TOKEN,in_memory=True)
